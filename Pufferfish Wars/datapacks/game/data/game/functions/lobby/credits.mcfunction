...
tellraw @s [{"text":" Denniss","color":"blue","bold":true,"hoverEvent":{"action":"show_text","value":[{"text":"Discord: ","color":"#7289da"},{"text":"Dennis#8458","color":"white"}]}}]
tellraw @s [{"text":""}]
tellraw @s [{"text":"▶ General Support and Testing: ","color":"white","italic":false}]
tellraw @s [{"text":" marhjo","color":"red","bold":true},{"text":", ","color":"gray","bold":false},{"text":"InternetAlien","color":"aqua","bold":true}]
tellraw @s [{"text":""}]
